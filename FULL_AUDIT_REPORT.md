# FULL AUDIT REPORT — Catalog/Filters/Buttons (UI + URLState)
...
6) Кнопки кімнат — синхронізація `aria-pressed` і класів для всіх кнопок.
...
## Відомі покращення (можна зробити окремо)
